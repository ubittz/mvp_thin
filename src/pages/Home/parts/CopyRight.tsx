  ...
  return (
    <StyledCopyRight>
      ...
      <div className='copy_right__item'>
        ...
        <Typography.Caption color={COLORS.GRAY_SCALE_400}>
          경기도 안산시 단원구 원포공원1로 59, 에이동 5층 17호(초지동, 신명트윈타워)
        </Typography.Caption>
        <Typography.Caption color={COLORS.GRAY_SCALE_400}>사업자등록번호 811-81-03556</Typography.Caption>
      </div>
      <div className='copy_right__item'>
        <Typography.Caption color={COLORS.GRAY_SCALE_400}>고객센터 &#40;평일 09:00 ~ 20:00&#41;</Typography.Caption>
